...
import { ArrowLeft, ArrowRight, Check, Info, Loader2, Search } from 'lucide-react';
...
const STEPS = ['Select Employee', 'Select Beneficiary', 'Choose Tests', 'Review & Submit'];
...
export default function NewRequestPage() {
  ...
  const canNext =
    step === 0 ? !!selectedEmployee : step === 1 ? !!beneficiary : step === 2 ? selectedTests.size > 0 : true;

  const handleSubmit = () => {
    if (!selectedEmployee || !beneficiary || selectedTests.size === 0) return;
    submit.mutate(
      {
